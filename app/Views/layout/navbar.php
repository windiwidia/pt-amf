        ...
        <li class="nav-item">
            ...
            <div id="collapsewebsite" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="/carousel-home">Carousel Home</a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown no-arrow">
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            ...
                            <span class="mr-2 d-none d-lg-inline text-gray-600 small">Hi <?= ucfirst($data['firstname']); ?> !</span>
                            <!-- image profile tidak jalan -->
                            <img class="img-profile rounded-circle" src="/img/profile/<?= $data['image']; ?>">
                        </a>
                        <!-- Dropdown - User Information -->
                        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                            <a class="dropdown-item" href="/admin/myprofile/<?= $data['slug']; ?>">
